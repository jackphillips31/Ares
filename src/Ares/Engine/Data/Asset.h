...
namespace Ares {
	...
	public:
		 ...
		 */
		inline const Vector<uint32_t>& GetDependencies() const { std::shared_lock lock(m_Mutex); return m_Dependencies; }
	...
	private:
		...
		String m_Filepath;						///< Filepath of the asset.
		String m_TypeName;						///< Type name of the asset.
		std::type_index m_Type;					///< Type index of the asset.
		Vector<uint32_t> m_Dependencies;		///< List of asset's dependencies in the form of IDs.
