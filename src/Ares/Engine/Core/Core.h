 ...
 * 
 * ## ***List of Macros***:
 * @li @ref platform_defines
 * @li @ref processor_defines
 * @li @ref endianness_defines
 * @li @ref compiler_defines
 * @li @ref system_defines
 * @li @ref debug_defines
 * @li @ref utility_defines
 * 
 */
#pragma once
